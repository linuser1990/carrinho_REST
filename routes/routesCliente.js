...
router.get('/formClienteMaisComprouPeriodoPDF',clienteController.showFormClienteMaisComprouPeriodoPDF)
...
router.post('/clienteMaisComprouPeriodoPDF',clienteController.clienteMaisComprouPDF)
